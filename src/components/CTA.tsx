...
export function CTA({onTryDemo}: HeroProps) {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="relative overflow-hidden rounded-3xl">
                    ...
                    <div className="absolute inset-0">
                        ...
                        />
                        <div
                            className="absolute inset-0 bg-gradient-to-r from-zinc-950 via-zinc-950/95 to-zinc-950/90"/>
                    </div>
                    ...
                    <div className="relative px-8 py-20 sm:px-16 lg:px-24">
                        <div className="mx-auto max-w-3xl text-center space-y-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Button
                                    size="lg" className="bg-blue-600 hover:bg-blue-700 text-white group h-12 px-8"
                                    onClick={onTryDemo}
                                >
                                    Start for free
