...
- НЕ пиши текст внутри полей, где ожидается объект.
- summary — короткий текст, все остальные поля — строго как в примере.
- original должен быть JSON-ОБЪЕКТОМ, не строкой.
- alternatives должен быть МАССИВОМ объектов.
- НЕ используй markdown.
- НЕ добавляй символы %, только строки.
